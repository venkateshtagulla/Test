...
from models.request.inspection_assignment import (
    BulkCreateInspectionAssignmentRequest,
    CreateCrewInspectionAssignmentRequest,
    CreateInspectionAssignmentRequest,
    DeleteInspectionAssignmentRequest,
    GetInspectionAssignmentRequest,
    ListInspectionAssignmentsRequest,
)
...
def create_inspection_assignment_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:  # pylint: disable=unused-argument
    ...
    try:
        ...
        payload = CreateInspectionAssignmentRequest(**body)
        data = service.create_assignment(admin_id, payload)
...
def get_inspection_assignment_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:  # pylint: disable=unused-argument
    ...
    try:
        ...
        payload = GetInspectionAssignmentRequest(**params)
        data = service.get_assignment(payload)
...
def list_inspection_assignments_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:  # pylint: disable=unused-argument
    ...
    try:
        ...
        payload = ListInspectionAssignmentsRequest(
...
def bulk_create_inspection_assignment_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:  # pylint: disable=unused-argument
    ...
    try:
        admin_id = _get_admin_id_from_event(event)
        body = parse_json_body(event)
        payload = BulkCreateInspectionAssignmentRequest(**body)
        data = service.bulk_create_assignments(admin_id, payload)
...
def create_crew_inspection_assignment_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:  # pylint: disable=unused-argument
    ...
    try:
        ...
        payload = CreateCrewInspectionAssignmentRequest(**body)
        data = service.create_crew_assignment(admin_id, payload)
...
def delete_inspection_assignment_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:  # pylint: disable=unused-argument
    ...
    try:
        ...
        payload = DeleteInspectionAssignmentRequest(form_id=form_id)
